...
import com.india.ecommerce.request.ResponseMsg;

//import com.india.icicibank.request.ResponseMsg;
...
public class WebRestControllerAdvice extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = InavalidArgumentException.class)
	public ResponseEntity<ResponseMsg> handleInavalidArgumentException(InavalidArgumentException ex) {
		ResponseMsg responsemsg = new ResponseMsg();
	...
	@ExceptionHandler(value = InavalidUserException.class)
	public ResponseEntity<ResponseMsg> handleAccountNotFoundException(InavalidUserException ex) {
		ResponseMsg responsemsg = new ResponseMsg();
	...
	public ResponseEntity<ResponseMsg> handleAccounFromNotFoundException(AccountNumberNotFoundException ex) {
		ResponseMsg responsemsg = new ResponseMsg();
